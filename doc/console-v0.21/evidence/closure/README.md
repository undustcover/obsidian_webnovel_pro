...
| P0-093 回归与候选包 | 完整测试、coverage、审计、10k benchmark、artifact verifier | 01～32 | `P0-093-engineering-validation.md`（待生成） | `P0-093-legacy-regression.md`、`P0-093-release-candidate.md`、`P0-093-rc-smoke.md`（待生成） |
